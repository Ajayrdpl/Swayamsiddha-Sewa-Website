    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
            आपका कोई प्रश्न है, किसी कार्यक्रम में भाग लेना चाहते हैं,
            या स्वयं सिद्ध साहित्यिक संस्थान जयपुर राजस्थान से जुड़ना चाहते हैं?
            हमें आपसे जुड़कर खुशी होगी।
          </p>
        ...
        <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          >
            ...
            <p className="mt-3 leading-7 text-slate-300">
              साहित्यिक कार्यक्रमों, सहयोग, भागीदारी और अन्य
              जानकारियों के लिए हमसे संपर्क करें।
            </p>
          ...
          >
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="हम आपकी कैसे सहायता कर सकते हैं?"
                  className="w-full rounded-xl border border-slate-200 bg-[#FDFBF7] px-4 py-3.5 text-sm outline-none transition focus:border-[#D4A72C] focus:ring-2 focus:ring-[#D4A72C]/20"
                />
              </div>
