        ...
        <div className="grid min-h-[calc(100vh-99px)] items-center gap-12 py-16 lg:grid-cols-2 lg:py-20">
          ...
          <div className="relative z-20 max-w-2xl">
            ...
            >
              ...
              <span className="text-sm font-semibold tracking-wide text-[#123E73]">
                साहित्य • ज्ञान • संस्कृति का उत्सव
              </span>
...
{/* 
                <motion.span
                  ...
                  className="absolute bottom-2 left-1 h-[2px] rounded-full bg-[#D4A72C]"
                /> */}
            ...
            >
              ...
              सांस्कृतिक मंच है, जो लेखकों, कवियों, विचारकों और साहित्य प्रेमियों
              को सार्थक कार्यक्रमों, संवादों और रचनात्मक अभिव्यक्तियों के माध्यम
              से एक साथ जोड़ने के लिए समर्पित है।
            </motion.p>
