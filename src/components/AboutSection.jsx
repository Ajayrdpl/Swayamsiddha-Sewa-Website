      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-xl text-lg leading-8 text-white/65 lg:ml-auto">
            ...
            स्वयं सिद्ध साहित्यिक संस्थान जयपुर, राजस्थान सार्थक संवाद,
            साहित्यिक आयोजनों और रचनात्मक अभिव्यक्तियों के माध्यम से
            साहित्य, ज्ञान और संस्कृति को एक साथ जोड़ता है।
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="mt-7 max-w-2xl text-base leading-8 text-white/65 sm:text-lg">
                ...
                साहित्यिक संवाद और लेखक परिचर्चाओं से लेकर सांस्कृतिक
                आयोजनों और रचनात्मक कार्यक्रमों तक, हम ऐसे मंच तैयार करते हैं
                जहाँ विचार साझा किए जाते हैं, कहानियों का उत्सव मनाया जाता है
                और हर आवाज़ को सुना जाता है।
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:col-span-5 lg:grid-cols-1">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-2xl font-bold text-white">
                  आवाज़ों का एक समुदाय
                </h4>


                <p className="mt-3 leading-7 text-white/60">

                  लेखकों, कवियों, वक्ताओं, पाठकों और साहित्य प्रेमियों
                  को साझा अनुभवों के माध्यम से एक साथ जोड़ना।
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 leading-7 text-white/75">
                  ...
                  साहित्य और संस्कृति में रचनात्मकता, ज्ञान और
                  सार्थक योगदान को सम्मानित करना।
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="mt-2 text-xl font-semibold leading-8 text-white sm:text-2xl">
                  हर कहानी में लोगों को जोड़ने, प्रेरित करने और बदलाव लाने की शक्ति होती है।
                </p>
