...
const interviews = [
  ...
  {
    title: "कविता, संस्कृति और एक पीढ़ी की आवाज़",
    category: "कवि संवाद",
    image: "/img4.png",
    views: "212 व्यूज़",
    duration: "48:32",
  ...
  {
    title: "हमें आकार देने वाली कहानियाँ: रचनात्मकता पर एक संवाद",
    category: "साहित्यिक वार्ता",
    image: "/img5.png",
    views: "178 व्यूज़",
    duration: "55:10",
  ...
  {
    title: "क्षेत्रीय साहित्य एवं विरासत का उत्सव",
    category: "सांस्कृतिक संवाद",
    image: "/img6.png",
    views: "203 व्यूज़",
    duration: "1:12:04",
  },
      ...
      <section className="relative overflow-hidden bg-[#FDFBF6] pb-8 pt-16 lg:pb-10 lg:pt-20">
        ...
        <div className="relative mx-auto max-w-[1400px] px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-5xl font-bold leading-tight text-[#123E73] sm:text-6xl">
              ऐसी आवाज़ें जो
              <span className="block text-[#C99722]">प्रेरित और जोड़ती हैं।</span>
            </h1>

            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600">
              लेखकों, कवियों, विद्वानों और विशिष्ट व्यक्तित्वों के साथ सार्थक
              संवाद, साहित्यिक चर्चाएँ और प्रेरणादायक सत्र देखें।
            </p>
